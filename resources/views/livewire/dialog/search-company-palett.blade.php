	...
	<div class="fixed inset-0 z-10 w-screen overflow-y-auto p-4 sm:p-6 md:p-20">
		...
		>
			...
			<form class="relative">
				...
				<input
					autofocus
					class="h-12 w-full border-0 bg-transparent pl-11 pr-4 text-white placeholder:text-gray-400 focus:outline-none focus:ring-0 sm:text-sm"
					placeholder="Search..."
					type="text"
					wire:keyup.debounce.250ms="searchCompany"
					...
					@if ($companies->count())
						...
						>
							@foreach ($companies as $company)
								<li
									class="flex cursor-default select-none px-4 py-2 text-white hover:bg-white/5"
									role="company"
									tabindex="-1"

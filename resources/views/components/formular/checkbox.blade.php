<div class="group flex items-start gap-x-3">
	{{-- checkbox --}}
	<div class="relative shrink-0">
		<input
			...
			class="size-4 peer appearance-none rounded shadow-sm ring-1 ring-zinc-950/10 checked:ring-transparent group-hover:ring-zinc-950/20 checked:group-hover:ring-transparent dark:bg-white/5 dark:ring-white/10 dark:group-hover:ring-white/20 dark:checked:group-hover:ring-transparent"
			type="checkbox"
		>

		<div
			class="size-4 pointer-events-none absolute left-0 top-0.5 hidden items-center justify-center rounded bg-blue-500 peer-checked:flex"
		>
			<svg

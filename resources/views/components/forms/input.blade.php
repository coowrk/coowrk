<div>
    <input {{ $attributes->filter(fn($value, $key) => !in_array($key, ['style', 'theme'])) }}
        {{ $errors->has($attributes->get('name')) ? 'data-invalid' : '' }} @class([
            ...
            // Theme Transparent
            'data-[override-style]:bg-transparent data-[override-style]:dark:bg-transparent data-[override-style]:dark:ring-0 data-[override-style]:focus:dark:ring-transparent' =>

			...
			>
				...
				<nav class="flex flex-1 flex-col">
					...
					>
						...
						<li class="mt-auto">
							<a
								class="group -mx-2 flex gap-x-3 rounded-lg p-2 text-sm/6 font-semibold text-gray-500 hover:bg-black/5 hover:text-gray-900 dark:text-zinc-500 dark:hover:text-white"
								href="#"
							>
								<svg
									aria-hidden="true"

<x-layouts.guest.default-layout>
	<section class="flex min-h-screen w-full items-center">
		<div class="mx-auto max-w-[85rem] px-4 sm:px-6 lg:px-8">
			...
			<div class="grid gap-4 md:grid-cols-2 md:items-center md:gap-8 xl:gap-20">
				<div>
					<h1 class="block text-3xl font-bold text-gray-800 dark:text-white sm:text-4xl lg:text-6xl lg:leading-tight">Start
						your journey with <span class="text-blue-600">Preline</span></h1>
				...
				<div class="relative ms-4">
					...
					>
					<div
						class="size-full absolute inset-0 -z-[1] -mb-4 -ms-4 me-4 mt-4 rounded-md bg-gradient-to-tr from-gray-200 via-white/0 to-white/0 dark:from-neutral-800 dark:via-neutral-900/0 dark:to-neutral-900/0 lg:-mb-6 lg:-ms-6 lg:me-6 lg:mt-6"
					></div>

					<!-- SVG-->
					<div class="absolute bottom-0 start-0">
						<svg
							class="ms-auto h-auto w-2/3 text-white dark:text-neutral-900"
							fill="none"
							height="451"
							viewBox="0 0 630 451"
							width="630"
